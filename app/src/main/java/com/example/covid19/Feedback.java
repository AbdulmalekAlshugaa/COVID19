...
public class Feedback extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(Feedback.getText().toString())){
                    Toast.makeText(com.example.covid19.Feedback.this,"Error", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(com.example.covid19.Feedback.this,"Thanks for your feedback", Toast.LENGTH_LONG).show();
                        }else {
                            mProgressDialog.dismiss();
                            Toast.makeText(com.example.covid19.Feedback.this,"Error", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(com.example.covid19.Feedback.this, MainActivity.class);
