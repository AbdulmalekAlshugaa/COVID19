...
public class News extends AppCompatActivity implements AdvancedWebView.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView = (AdvancedWebView) findViewById(R.id.webviewN);
        TracToolBar = findViewById(R.id.TracToolBar);
        TracToolBar.setTitle(getResources().getString(R.string.news));
        TracToolBar.setTitleTextColor(getColor(R.color.white));
        setSupportActionBar(TracToolBar);

        // mWebView.setListener(Payment.this);
        mWebView.setListener(News.this, this);

        mWebView.loadUrl("https://www.bbc.com/arabic");
    }
